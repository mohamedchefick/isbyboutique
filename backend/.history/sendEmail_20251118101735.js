...
// Normalize image URLs: accept absolute URLs, or convert relative paths
// to an absolute URL based on FRONTEND_ORIGIN (or localhost fallback).
...
app.post("/send-email", async (req, res) => {
  ...
  try {
    await apiInstance.sendTransacEmail({
      sender: { name: "My store", email: senderEmail },
