...
app.post("/send-email", async (req, res) => {
        ...
        <tr>
          <td style="padding: 20px 0;">
            <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
              ...
              <tr>
                <td style="background: linear-gradient(135deg, #E4D1BB 0%, #43a047 100%); padding: 30px 25px; text-align: left; position: relative;">
  ...
  try {
    await apiInstance.sendTransacEmail({
      sender: { name: "MyStore", email: senderEmail },
