...
<div v-if="showModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
  <div class="bg-white dark:bg-gray-800 rounded-xl p-6 max-w-lg w-full relative">
    ...
    <p class="text-gray-700 dark:text-gray-300 mb-2"><strong>Prix:</strong> {{ selectedProduct.price }} €</p>
    <p class="text-gray-700 dark:text-gray-300 mb-2"><strong>Date:</strong> {{ new Date(selectedProduct.createdAt?.seconds * 1000).toLocaleDateString() }}</p>
    <p class="text-gray-700 dark:text-gray-300" v-html="selectedProduct.description"></p>
  </div>
</div>
