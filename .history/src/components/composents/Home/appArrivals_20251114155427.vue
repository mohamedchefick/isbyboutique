    ...
    <div :class="[isDarkMode ? 'dark' : '', 'arrivals-container mx-5 my-10']" ref="arrivalsContainer">
        ...
        <div class="flex flex-wrap justify-between items-center mb-4 gap-4">
            ...
            <select v-model="selectedFilter" class="p-2 border border-gray-300 rounded-lg">
                ...
                <option value="category1">{{ $t('category1') }}</option>
                <option value="category2">{{ $t('category2') }}</option>
            </select>
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
            ...
            <p v-else class="text-gray-500 dark:text-gray-300 text-center py-6">{{ $t('noProducts') }}</p>
        </div>
