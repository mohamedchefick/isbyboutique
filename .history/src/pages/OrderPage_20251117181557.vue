    ...
    <div class="bg-white border-b border-gray-200 sticky top-0 z-40 shadow-sm">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <div class="flex items-center justify-between">
          <button @click="goBack"
            class="text-[#da9a90] hover:text-[#c88980] font-semibold flex items-center gap-2 transition-colors group">
          ...
          <div class="flex items-center gap-3 sm:gap-4">
            <div class="bg-[#da9a90]/10 p-2 sm:p-3 rounded-xl">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sm:h-8 sm:w-8 text-[#da9a90]" fill="none"
...
async function saveClientInfo() {
  ...
  try {
    ...
    alert("Informations et panier envoyés par email !");
  } catch (error) {
    console.error(error);
