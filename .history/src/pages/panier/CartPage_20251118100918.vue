...
function OrderPage() {
    // Vérifier que le panier est bien sauvegardé avant de naviguer
    console.log('🛒 Panier avant navigation:', cartStore.cart);
...
<!-- Le template reste identique, je ne le répète pas -->
